...
import org.example.springwebtest.learning.ch10.deserialization.JKidException
...
fun serializerForType(type: Type): ValueSerializer<out Any?>? =
        when(type){
            ...
            Short::class.java, Short::class.javaObjectType -> ShorSerializer
...
object ShorSerializer: ValueSerializer<Short> {
